...
| Extractor | Median | Range |
| --- | ---: | ---: |
| Codeberg Go-Readability v2.1.2 | 2,024 ms | 1,916-2,919 ms |
| Go-ReadabilityV2 | 1,946 ms | 1,836-2,759 ms |
| Rust-Readability | 952 ms | 878-1,374 ms |
